...
affiliation: <img src="images/USSEIN-LOGO-entete-site.png" width="80" style="margin-right:360px;"/><img src="images/logo_mate_shs_0.png" width="150" style="margin-right:360px;"/><img src="images/logo_PRODIG.png" width="70" />
img: images/kobo.png
lang: fr
format:
  revealjs: 
    ...
    footer: "Tuto@MATE - KoBotoolBox, un outil libre de collecte de données pour les SHS"
    scrollable: FALSE
    smaller: TRUE
    overview: TRUE
    chalkboard: FALSE
...
1. **Plateforme de suivi des réalisations du projet PRAPS**

::: center
![](images/praps%202.jpg){width="65%"}
:::


## Exemples personnels appliqués

2. **Connectivité des étudiants** ([formulaire](https://ee.kobotoolbox.org/x/GKiHvleT){target="_blank"}) 

::: center
![](images/internet.jpg){width="75%"}
...
3. **Cartographie des projets et programmes du secteur rural en Guinée** ([formulaire](https://ee.KoBotoolBox.org/x/8n6LAaXy){target="_blank"}) 


::: center
![](images/pasag.png){width="100%"}
:::

## Exemples personnels appliqués


4. **Conflits fonciers** ([formulaire](https://ee.KoBotoolBox.org/x/DQ9Jje0M){target="_blank"})

::: center
![](images/conflits%20fonciers.jpg){width="75%"}
...
5. **Cartographie des structures de formations professionnelles et techniques du Sénégal** ([formulaire](https://ee.KoBotoolBox.org/x/GlZTfTgW){target="_blank"}) 

::: center
![](images/FPT.png){width="80%"}
:::

## Exemples personnels appliqués


6. **Cartographie des structures de formation agricole et rurale.** ([formulaire](https://ee.kobotoolbox.org/x/94cwK1ga){target="_blank"}) 

::: center
![](images/warwi.png){width="75%"}

:::

## Exemples personnels appliqués

7. Projet **HOTOSM 2020 - Sites de santé au Sénégal** ([https://healthsites.io/map](https://healthsites.io/map))

::: center
![](images/andysouth.png){width="85%"}
:::
...
::: center
[**Cliquez sur le signe + pour ajouter votre première question :**]{.txt2}

![](images/5a.jpg){width="80%"}
:::

::: center
[**Définissez le type de question souhaité :**]{.txt2}

![](images/7a.jpg){width="80%"}
:::
...
Une fois le questionaire saisi et validé, **il doit être déployé pour activer la phase de collecte. Un lien sera automatiquement créé.**

::: center
![](images/deploy.jpg){width="85%"}

![](images/link.jpg){width="85%"}
:::
...
::: txt6
-   [Guide de formation KoBoToolbox](https://docs.google.com/presentation/d/1vJMWBBcMNlnQP1dUa7WsTuA4mSwifgEnj-TtjGwmcuY/htmlpresent){target="_blank"}
-   [Manuel CartONG](https://cartong.pages.gitlab.cartong.org/learning-corner/fr/8_managing_mdc/8_2_tool_focus_page){target="_blank"}
:::
...
::: {.column width="55%"}
::: center
![](images/logo_mate_shs_0.png){width="55%"}
:::
:::
...
::: {.column width="20%"}
![](images/geographie-cites_logo.png){width="80%"}
:::
